...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-black border-b border-white/10 z-50">
      <div className="max-w-7xl mx-auto h-20 lg:h-18  flex items-center px-3 justify-between">
        {/* Logo */}
        <Link
          to="/"
        ...
        {/* CTA Button */}
          <button className="px-2 py-2 lg:px-3 lg:py-3 text-sm lg:text-2xl lg:rounded-lg rounded-full font-semibold text-white bg-gradient-to-r from-yellow-500 to-orange-500 hover:opacity-90 transition">
            Go Premium
          </button>
