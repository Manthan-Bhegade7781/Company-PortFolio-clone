...
const Price = () => {
  return (
    <section
      id="pricing"
      className="relative overflow-hidden bg-black py-16 lg:py-22 px-5 sm:px-8 lg:px-20"
    >
      <div className="relative mx-auto max-w-[1400px] lg:px-8">
        {/* Heading */}
        <div className="text-center">
          <h2 className="text-3xl sm:text-2xl lg:text-4xl text-white font-bold">
            Simple Pricing
          </h2>

          <p className="mt-4 lg:mt-4 text-sm lg:text-lg text-gray-400 max-w-3xl mx-auto leading-7">
            ...
            plan.popular ? (
              ...
              >
                <div className="relative h-full rounded-[23px] lg:rounded-[29px] bg-black backdrop-blur-xl p-6 lg:p-8">
                  ...
                  <h3 className="mt-5 lg:mt-6 text-2xl lg:text-3xl text-white font-semibold">
                    {plan.title}
                  </h3>

                  <div className="mt-6 lg:mt-8 flex items-end gap-2">
                    <span className="text-5xl text-white lg:text-6xl font-extrabold">
                      {plan.price}
                    </span>
              ...
              >
                <h3 className="mt-2 lg:mt-6 text-2xl text-white lg:text-3xl font-semibold">
                  {plan.title}
                </h3>
